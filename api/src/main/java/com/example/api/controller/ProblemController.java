...
public class ProblemController {
	...
	public ResponseEntity<RandomProblemResponse> getRandomProblem(
		...
		return ResponseEntity.ok(RandomProblemResponse.from(
			getRandomProblemUseCase.getRandomProblem(request.chapterId(), userId)
		));
	}
	...
	public void skipProblem(
		@LoginUserId Long userId,
		@Valid @RequestBody SkipProblemRequest request
	) {
		problemCommandUseCase.skipProblem(userId, request.chapterId(), request.problemId());
	}
	...
	public ResponseEntity<SubmitAnswerResponse> submitAnswer(
		...
		return ResponseEntity.ok(SubmitAnswerResponse.from(
			problemCommandUseCase.submitAnswer(request.problemId(), userId, request.userAnswers())
		));
	}
}
